...
@about
    ## Auto trim and fade left edge of items (SWS Config A) (good group behaviour)
    Trims an item at the edit cursor - the SWS Config A fade in length, sets the fade in to the same length
@changelog
    [1.0] - 2019-07-09
    + Initial release
