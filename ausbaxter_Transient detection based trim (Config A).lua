...
@version 1.0
@author ausbaxter
@description Transient Detection Based Trim (Using Command Parameters Config A)
@about
    ## Transient Detection Based Trim (Using Command Parameters Config A)
    ...
    SWS command parameter fade lengths from config A are used to buffer the edit points.
...
local fade_in_len = command_parameters.A.fade_in_len
local fade_out_len = command_parameters.A.fade_out_len
