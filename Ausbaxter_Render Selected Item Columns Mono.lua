--[[
 * ReaScript Name: Render Selected Item Columns Mono
 * Description: Sequentually renders a selection of items based on item columns (including track sends etc). Populates to a new track.
 ...
 * File URI: https://github.com/ausbaxter/Reascripts/Ausbaxter_Render Selected Item Columns Mono.lua
 * Licence: GPL v3
 * REAPER: 5.xx
 * Extensions: None
 * Version: 1.1
...
function FirstRenderTrackIndex() --get index of first track of selected items

  local trackIndex = 0
  
  for i, track in ipairs(mediaItemTracks) do
...
function CreateParentTrack()
  ...
  local trackIndex = FirstRenderTrackIndex() 
