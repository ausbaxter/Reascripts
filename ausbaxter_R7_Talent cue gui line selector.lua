...
function main()
	...
	GUI.name = "Talent Cue Line Selector"
	GUI.x, GUI.y, GUI.w, GUI.h = 0, 0, 400, 1000
	...
	GUI.New("list", "Listbox", 1, 10, 10, gfx.w - 20, gfx.h - 20, "test,test2,test3", true, "", 0)
