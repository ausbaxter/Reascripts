...
@about
    ## Auto trim and fade right edge of items (SWS Config B) (good group behaviour)
    Trims an item at the edit cursor - the SWS Config B fade out length, sets the fade to the same length
@changelog
    [1.0] - 2019-07-09
    + Initial release
