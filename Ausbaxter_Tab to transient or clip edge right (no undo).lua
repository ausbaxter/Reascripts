--[[
 * ReaScript Name: Tab to transient or clip edge right (no undo)
 * Description: Tabs to clip edges and transients without creating bloated undo's
 * Instructions: Assign the  Tab and profit
 * Author: Ausbaxter
 * Author URI: https//:austinbaxtersound.com
 * Repository: GitHub > Ausbaxter
 * Repository URL: https://github.com/ausbaxter/Reascripts
 * File URI: https://github.com/ausbaxter/Reascripts/Ausbaxter_Tab to transient or clip edge right (no undo).lua
 * Licence: GPL v3
 * REAPER: 5.xx
 * Extensions: None
 * Version: 1.0
