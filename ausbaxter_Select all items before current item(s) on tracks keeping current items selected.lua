...
local c_item = reaper.CountSelectedMediaItems(0)
local l_item = reaper.GetSelectedMediaItem(0, c_item - 1)
local item_track = reaper.GetMediaItemTrack(l_item)
local idx = reaper.GetMediaItemInfo_Value(l_item, "IP_ITEMNUMBER")
