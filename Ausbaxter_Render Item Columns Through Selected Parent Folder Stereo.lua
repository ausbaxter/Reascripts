--[[
 * ReaScript Name: Render Item Columns Through Selected Parent Folder Stereo
 ...
 * File URI: https://github.com/ausbaxter/Reascripts/Ausbaxter_Render Item Columns Through Selected Parent Folder Stereo.lua
 * Licence: GPL v3
 * REAPER: 5.xx
 * Extensions: None
 * Version: 1.0
